\section{Definitions, Acronyms and Abbreviations}
    ...
    \subsection{Definitions}
        \begin{itemize}
            \item \textbf{Application, Software}: these terms refer to \emph{Data4Help}, \emph{AutomatedSOS} or \emph{Track4Run}, depending on which of them is being described, in their entirety (design and implementation alike).
