\section{Functional Requirements}
            ...
            \begin{table}[H]
                ...
                \begin{tabular}{|p{3cm}|p{8.2cm}|}
                    ...
                    \textbf{Exit Condition} & The Third-party is registered and able to log into \emph{Data4Help}. \\
                     \hline
                    \textbf{Exception} & The Visitor is not able to register because the email is                        already in use. \newline
            ...
            \begin{table}[H]
                ...
                \begin{tabular}{|p{3cm}|p{8.2cm}|}
                    ...
                    \textbf{Entry Condition} & The user has a D4H account. \\
                     \hline
                    \textbf{Events Flow} & \begin{enumerate}
                                               \item The Individual logs into his D4H personal account.
            ...
            \begin{table}[H]
                ...
                \begin{tabular}{|p{3cm}|p{8.2cm}|}
                    ...
                    \textbf{Entry Condition} & The user has an ASOS account and is logged in. \\
                     \hline
                    \textbf{Events Flow} & \begin{enumerate}
                                               \item D4H collects through the connected device a critical bpm value relative to the Elderly person.
                                               \item ASOS checks if the value is under the critical threshold.
                                               \item ASOS contacts the ambulance service, giving the location of the Elderly person gathered with the last measurement.
    ...
    \subsection{Track4Run}
        ...
        \subsubsection{Organiser registration and log in}
            Any Organiser need to register to T4R before being able to organise and publish races. This account is in no way dependant to D4H and Organisers do not need to be registered to D4H too. Therefore, if they are already registered to D4H as Third-parties, they still need a new account, but can use the same information provided for D4H. 
        ...
        \subsubsection{Enrolment to a run}
            ...
            \begin{table}[H]
                ...
                \begin{tabular}{|p{3cm}|p{8.2cm}|}
                    ...
                    \textbf{Goals} & \\ 
                     \hline
                    \textbf{Entry Condition} & The Participant is logged into D4H using his Individual account. \\
                     \hline
                    \textbf{Events Flow} & \begin{enumerate}
        ...
        \subsubsection{Participant tracking}
            ...
            \subsubsection{Rank history}
                Participants and Organisers are able to see the rank for all past races they have took part in or organises, respectively. Since the procedure to access the rank history is the same for the two actors, only one use case is provided.
