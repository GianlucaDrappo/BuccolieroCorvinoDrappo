\section{Functional Requirements}
            ...
            \begin{table}[H]
                ...
                \begin{tabular}{|p{3cm}|p{8.2cm}|}
                    ...
                    \textbf{Entry Condition} & Third-party has to be registered to Data4Help.\\
                     \hline
                    \textbf{Events Flow} & \begin{enumerate}
                                                \item The Third-Party selects ``\emph{Search by Fiscal Code}" and it inserts the Fiscal Code of the desired person.
            ...
            \begin{table}[H]
                ...
                \begin{tabular}{|p{3cm}|p{8.2cm}|}
                    ...
                    \textbf{Exit Condition} & Third-party receives updated data with specified granularity and frequency. \\
                     \hline
                    \textbf{Exception} & The system go out from loop when \emph{Single User data unsubscription} or \emph{Aggregated user data unsubscription} start, according to what kind of data the third-party is subscribed. \\
                     \hline
                \end{tabular}  
            \end{table} 
    ...
    \subsection{Track4Run}
        ...
        RunTogether is a group interested in the organisation of runs in Milan. After \emph{TrackMe} has launched \emph{Track4Run}, the company decides to download \emph{Data4Help} and to register only to the \emph{Track4Run} service, not being interested in the other features of the software. It then tries to publish a run held at Parco Sempione, on 11/11/2018 at 9.30, allowing 30 participants. Since there is another run scheduled at the same place and time, \emph{Track4Run} shows an error message. RunTogether then decides to delay the competition until 12 and manages to publish it successfully. It then receives a confirmation mail with the summary of the process.
        
        Matteo enjoys jogging and wants to try to compete in a race. Therefore, he downloads \emph{Data4Help} application on his smart-phone and registers to the service. Then, he goes in the \emph{Track4Run} section and searches for the runs available in Milan in November. He then selects RunTogether's race, since it still has open slots, and enrols to it, pressing on the specific button. \emph{Track4Run} sends him an email as confirmation.
        
        The day of the race, Matteo's girlfriend, Jessica, wants to follow his route during the run. Therefore, she downloads \emph{Data4Help} application and goes in the tracking section of \emph{Track4Run}, without needing to register. She finds the run Matteo is enrolled in and selects it. \emph{Track4Run} then requests the map of the area from Google Maps and sends it back to Jessica with the location of the participants updating in real time.
        ...
        \subsubsection{Run organisation}
            ...
            \begin{figure}[H]
                \centering
                \makebox[\textwidth][c]{\includegraphics[scale=0.52]{pictures/OrganizationRunSequenceDiagram.png}}
        ...
        \subsubsection{Participant tracking}
            ...
            \begin{figure}[H]
                \centering
                \makebox[\textwidth][c]{\includegraphics[scale=0.65]{pictures/TrackingSequenceDiagram.png}}
    ...
    In this section, we will Keep track of relationship between goals, requirements and use cases. In order to do this, we build for each analysed services \emph{Traceability matrix}. It is important to highlight that the same use case could be linked to different requirements and the same requirement to different use cases. 
        ...
        \begin{table}[H]
                ...
                \begin{tabular}{|c|c|c|}
                    ...
                    \hline
                      & \ref{R3-ranking-storage}& Rank history\\
                    \hline
                \end{tabular}  
            \end{table}