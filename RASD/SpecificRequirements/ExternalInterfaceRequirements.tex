...
\begin{figure}[H]
  ...
  \subfigure[D4H Individual Login page]{\includegraphics[width=0.30\textwidth]{pictures/mockup/D4H-login.png}\label{fig:D4H-Individual-login}}
  \subfigure[D4H Third-party Login page]{\includegraphics[width=0.30\textwidth]{pictures/mockup/D4H-login-Enterprise.png}\label{fig:D4H-third-party-login}}
...
\begin{figure}[H]
  \centering
  \subfigure[Organiser log in]{\includegraphics[width=0.30\textwidth]{pictures/mockup/T4R-login-organiser.png}\label{fig:T4R-organizer-login}}
  \subfigure[Participant log in]{\includegraphics[width=0.30\textwidth]{pictures/mockup/T4R-login-runner.png}\label{fig:T4R-runner-login}}
