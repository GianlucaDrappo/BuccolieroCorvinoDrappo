...
\begin{enumerate}[label={[}R1.\arabic*{]}, leftmargin=*]
    ...
    \begin{enumerate}[label={[}R1.\arabic{enumi}.\arabic*{]}, leftmargin=*]
        ...
        \item \label{R1-group-data-anonymized} In order to anonimize data, the application only sends information related to the health status of individuals (e.g. bpm, step).
    \end{enumerate}
