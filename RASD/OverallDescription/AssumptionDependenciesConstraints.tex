\section{Assumptions, dependencies and constraints}
    ...
    \subsection{Domain assumptions}
        ...
        \begin{enumerate}[label={[}D1.\arabic*{]}]
            \item Data sampling is frequent enough. %maybe discuss this
        ...
        \subsubsection{AutomatedSOS}
            \begin{enumerate}[label={[}D2.\arabic*{]}]
                ...
                \item The threshold below which a person is considered to be in need of help is under XXX bpm. %define the threshold!
