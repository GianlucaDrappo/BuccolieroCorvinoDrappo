    // This assertion checks if a single request returns data to the Third-party if and only if the user's answer is positive
    ...
    // This assertion checks if a multiple request returns data if and only if the number of user with a
    // specific requirement is grater than 1000 (in the model we used 2 to semplify the check)
